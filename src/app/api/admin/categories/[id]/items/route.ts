// app/api/admin/categories/[id]/items/route.ts
import { createServerClient } from '@supabase/ssr';
import { NextRequest, NextResponse } from 'next/server';
import { cookies } from 'next/headers';
import { Database } from '@/types/supabase'; // You'll need to have this type defined
...
export async function POST(
  ...
  try {
    // Get the max display_order for the category's items
